              ...
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form class="user"  method="post" action="login">
                    ...
                    <hr>
                    <a href="ressources/index.html" class="btn btn-google btn-block">
                      <i class="fab fa-google fa-fw"></i> Login with Google
                    </a>
                    <a href="ressources/index.html" class="btn btn-facebook btn-block">
                      <i class="fab fa-facebook-f fa-fw"></i> Login with Facebook
                    </a>
                  </form>
                  <hr>
                  <div class="text-center">
                    <a class="font-weight-bold small" href="ressources/register.html">Create an Account!</a>
                  </div>
                  <div class="text-center">
                  </div>
                </div>
