			                    ...
			                    <div class="card-body">
				                  <form method="POST" action="add_marque">
				                    <div class="form-group">
				                      ...
				                      <input name="code" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
				                        placeholder="Code">
				                    </div>
				                     <div class="form-group">
				                      <label for="exampleInputEmail1">Libellé </label>
				                      <input  name="libelle" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
				                        placeholder="Libellé">
				                    </div>				                    
