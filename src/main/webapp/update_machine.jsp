...
<% ArrayList marques = (ArrayList)request.getAttribute("marques");%>
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ajouter une machine</h1>
                    </div>
                        ...
                        <div class="col-xl-8 col-lg-7 mb-4">
                            <div class="card">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <a class="m-0 float-right btn btn-danger btn-sm" href="ressources/#">View More <i
                      class="fas fa-chevron-right"></i></a>
                                </div>
			                    <div class="card-body">
				                  <form method="POST" method="POST" action="update_machine">
				                     <input type="hidden" value="<%=machine.getId()%>" name="id" class="form-control" id="exampleInputUsername1" placeholder="Username" required>
  
                      <div class="form-group">
                        <label for="exampleInputUsername1">Reference</label>
                        <input type="text" value="<%=machine.getReference() %>" name="reference" class="form-control" id="exampleInputUsername1" placeholder="Reference" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputUsername1">Date achat</label> 
                        <input class="form-control" value="<%=machine.getDateAchat()%>"  name="dateAchat" placeholder="yyyy-MM-dd">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputUsername1">Prix</label>
                        <input type="text" value="<%= machine.getPrix()%>" name="prix" class="form-control" id="exampleInputUsername1" placeholder="Prix" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputUsername1">marque</label>
                        <select class="form-control" name="marqueId" id="marque-select">
                        	 <option>Choisissez une marque</option>
	                         <% int index = 0; while (marques.size() > index){%>
	                          <% Marque marque = (Marque) marques.get(index++);%>
	                          <option value="<%=marque.getId()%>"<%if(marque.getId() == machine.getMarqueId()){%>selected<%}%> ><%=marque.getCode()%></option>
							<%}%>
						</select>
                      </div>
