        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <i class="fa fa-bars"></i>
	          ...
	          <div class="col-5 grid-margin">
	               <form method="GET" action="machines_between_dates">
	                 <div class="form-group">
                        <label for="exampleInputUsername1">Date de début</label> 
                        <input class="form-control" name="dateDebut" placeholder="yyyy-MM-dd">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputUsername1">Date fin</label> 
                        <input class="form-control" name="dateFin" placeholder="yyyy-MM-dd">
                      </div>
	          	  	 <button class="nav-link w-10 btn btn-primary create-new-button">Chercher achats entre dates</a>
	          	  </form>
	          </div>
	          <div class="col-5 grid-margin">
	          	  <form action="machine_by_marque" method="GET">
	          	     <div class="form-group">
                        <label for="exampleInputUsername1">Marques</label>
                        <select class="form-control" name="marqueId" id="marque-select">
	                         ...
	                         <% int index = 0; while (marques.size() > index){%>
	                          ...
	                          <option value="<%=marque.getId()%>"><%=marque.getCode()%></option>
							<%}%>
						</select>
                      </div>
	          	  	 <button class="nav-link w-10 btn btn-primary create-new-button">Chercher par marque</a>
	          	  </form>
	          </div>
          </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-xl-12 col-lg-7 mb-4">
                            <div class="card">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <a class="m-0 float-right btn btn-danger btn-sm" href="add_machine">Add new Machine <i
                      ...
                      class="fas fa-chevron-right"></i></a>
                                ...
                                <div class="table-responsive">
			                        ...
			                        <tbody>
			                        <% index = 0; while (machines.size() > index){%>
			                         <tr>
