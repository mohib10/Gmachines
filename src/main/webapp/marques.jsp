                                	...
                                	<table class="table align-items-center table-flush">
				                        ...
				                        <% int index = 0; while (marques.size() > index){%>
				                         <tr>
				                        	...
				                        	<td> <%= marque.getId()  %> </td>
				                            <td> <%= marque.getCode() %> </td>
				                            <td>  <%= marque.getLibelle() %></td>
				                            <td class="d-flex justify-content-start"> <a type="button" href="update_marque?id=<%= marque.getId()%>" class="btn btn-primary btn-sm m-2">Modifier</a> 
				                            <form method="POST" action="delete_marque">  <button type="submit" class="btn btn-danger btn-sm m-2"> <input type="hidden" value="<%=marque.getId()%>" name="id" /> Supprimer</button> </form></td>
				                          </tr>
										<%}%>
				                        </tbody>
				                      </table>
