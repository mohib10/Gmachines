			                    ...
			                    <div class="card-body">
				                  <form method="POST" action="add_machine">
				                     <div class="form-group">
				                        ...
				                        <input type="text" name="reference" class="form-control" id="exampleInputUsername1" placeholder="Reference" required>
				                      </div>
				                      <div class="form-group">
				                        <label for="exampleInputUsername1">Date achat</label>
				                        <input class="form-control"  name="dateAchat" placeholder="yyyy-MM-dd">
				                      </div>
				                      <div class="form-group">
