        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <i class="fa fa-bars"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="ressources/#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ajouter une marque</h1>
                    </div>
                        ...
                        <div class="col-xl-8 col-lg-7 mb-4">
                            <div class="card">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Ajouter une marque</h6>
                                    <a class="m-0 float-right btn btn-danger btn-sm" href="ressources/#">View More <i
                      class="fas fa-chevron-right"></i></a>
                                </div>
			                    <div class="card-body">
				                  <form method="POST" action="update_marque">
				                  <input type="hidden" value="<%= marque.getId()%>" name="id" class="form-control" id="exampleInputUsername1" placeholder="Username" required>
				                    <div class="form-group">
				                      <label for="exampleInputEmail1">Code </label>
				                      <input type="text" value="<%= marque.getCode()%>" name="code" class="form-control" id="exampleInputUsername1" placeholder="Username" required>
				                    </div>
				                     <div class="form-group">
				                      <label for="exampleInputEmail1">Libellé </label>
				                       <input type="text" value="<%= marque.getLibelle()%>" name="libelle" class="form-control" id="exampleInputUsername1" placeholder="Username" required>
				                    </div>				                    
